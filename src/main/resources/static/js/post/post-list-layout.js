const postListLayout = (() => {
    ...
    const showPostList = async (posts, reset = false) => {
        ...
        for (const post of posts) {
            ...
            const profileImg = (post.filePath && post.fileName && post.filePath !== "null" && post.fileName !== "null")
            ...
            console.log("로그인한 memberId:", String(memberId));
            console.log("게시글의 memberId:", String(post.memberId));
            console.log("팔로우 버튼 표시 여부:", String(post.memberId) !== String(memberId));
                ...
                <div class="user diary-theme">
                    ...
                    <div class="metadata">
                        ...
                        <div><span class="time">${formattedTime}</span></div>
                            ...
                            ${String(post.memberId) !== String(memberId)
