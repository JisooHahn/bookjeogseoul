...
public class SponsorMemberVO extends MemberVO {
    ...
    public SponsorMemberVO(MemberVOBuilder<?, ?> b, Long id, String sponsorEmail, String sponsorId, String sponsorMainAddress, SponsorMemberStatus sponsorMemberStatus, String sponsorName, String sponsorPassword, String sponsorPhoneNumber, String sponsorSubAddress) {
        super(b);
        this.id = id;
