...
//    게시판에 나올 10개의 기부 기록
    ...
    // 독후감 삭제
    public void deletePostAlarm(Long bookPostId);
    public void deleteBookPostLike(Long postId);
    public void deleteBookPostFile(Long postId);
    public void deletePost(Long bookPostId);
    public void deleteBookPost(Long bookPostId);

    // 단체회원 마이페이지 게시글 조회
    public List<ReceiverVO> selectMyReceivers(Long memberId);
    public List<DonateCertVO> selectMyDonateCerts(Long memberId);

    // 내가 작성한 전체 기부글, 기부인증글 목록
    public List<ReceiverPostDTO> selectMyAllReceiverPosts(Long memberId);
    public List<DonateCertPostDTO> selectMyAllDonateCerts(Long memberId);
    public List<MonthlyBookPostVO> selectAllMonthlyBookPosts(String date);

    public BestBookPostVO selectBestBookPostByDate(String date);
}
