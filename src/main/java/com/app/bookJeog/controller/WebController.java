...
public class WebController {
    ...
    public String goToMain(Model model, HttpSession session) throws IOException, JSONException {
            ...
            // 세션에서 alertMessage 가져오기
            String alertMessage = (String) session.getAttribute("alertMessage");
            if (alertMessage != null) {
                model.addAttribute("alertMessage", alertMessage);
                session.removeAttribute("alertMessage"); // 한 번만 표시 후 삭제
            }
       ...
       try {
           for (SelectedBookVO selectedBookVO : templist) {
               ...
               log.info("adminSelectBookDTO = {}", adminSelectBookDTO.toString());
       ...
       log.info("tempPost = {}", tempPost.toString());
