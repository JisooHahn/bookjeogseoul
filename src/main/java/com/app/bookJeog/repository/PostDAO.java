...
public class PostDAO {
    ...
    // 독후감 삭제
    public void deletePostAlarm(Long bookPostId){postMapper.deletePostAlarm(bookPostId);};
    public void deleteBookPostLike(Long postId){postMapper.deleteBookPostLike(postId);};
    public void deleteBookPostFile(Long postId){postMapper.deleteBookPostFile(postId);};
    ...
    // 단체회원 마이페이지 게시글 조회
    public List<ReceiverVO> findMyReceivers(Long memberId){ return postMapper.selectMyReceivers(memberId); };
    public List<DonateCertVO> findMyDonateCerts(Long memberId){ return postMapper.selectMyDonateCerts(memberId); };

    // 내가 작성한 전체 기부글, 기부인증글 목록
    public List<ReceiverPostDTO> findMyAllReceiverPosts(Long memberId){return postMapper.selectMyAllReceiverPosts(memberId);};
    public List<DonateCertPostDTO> findMyAllDonateCerts(Long memberId){return postMapper.selectMyAllDonateCerts(memberId);};
